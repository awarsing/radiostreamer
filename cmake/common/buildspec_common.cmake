...
function(_setup_obs_studio)
  ...
  set(_cmake_arch "-DCMAKE_OSX_ARCHITECTURES:STRING=${CMAKE_OSX_ARCHITECTURES}")
...
function(_check_dependencies)
  ...
  foreach(dependency IN LISTS dependencies_list)
    ...
    string(REPLACE "ARCH" "${dependency_arch}" file "${file}")
    string(REPLACE "ARCH" "${dependency_arch}" destination "${destination}")
    if(revision)
