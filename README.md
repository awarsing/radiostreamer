...
Download the latest signed and notarized build from <https://radiostreamer.app/download/macos.zip> and follow [INSTALL.md](INSTALL.md) for setup, first-stream, and troubleshooting steps.
